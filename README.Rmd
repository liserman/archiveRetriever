...
Sometimes, some of the rerieved urls are unable to access, producing an error message. Especially when retrieving links from a larger body of archive-urls, you may not want your process to break due to these unaccessible urls. For this purpose, you can use the `ignoreErrors` option.
