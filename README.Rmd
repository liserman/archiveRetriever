...
Here, the functions `retrieve_urls`, `retrieve_links` and `scrape_urls` can build apon eachother, each function can take the output of the previous function as input to continue the work process.
